    ...
    <>
      ...
      <section className="text-gray-400 body-font">
        <div className="container mx-auto flex flex-col px-5 py-24 justify-center items-center">
          <img
            className="lg:w-2/6 md:w-3/6 w-5/6 mb-10 object-cover object-center rounded-lg"
            alt="hero"
            src="/about.jpg"
          />
          <div className="w-full md:w-2/3 flex flex-col mb-16 items-center text-center">
            ...
            <div className="flex w-full justify-center items-end">
              <div className="relative mr-4 lg:w-full xl:w-1/2 w-2/4 md:w-full text-left">
                ...
                <input
                  ...
                  id="hero-field"
                  name="hero-field"
                  className="w-full rounded border bg-opacity-40 border-gray-700 focus:ring-2 focus:ring-blue-900 focus:bg-transparent focus:border-blue-500 text-base outline-none text-gray-100 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out"
                />
              </div>
            ...
            <p className="text-sm mt-2 text-gray-500 mb-8 w-full">
              dapatkan info menarik kami di App Store
            </p>
